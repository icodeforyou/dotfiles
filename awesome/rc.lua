...
user = {
    ...
    openweathermap_key = "e3882adab03174f120677c1e6584015f",
    openweathermap_city_id = "2715572",
...
-- Set xrandr 4K scaling with xrandr
awful.spawn("xrandr --output DP-0 --scale 1.2x1.2")
